...
modules_to_test = {
    'socrata_toolkit.material_standards': [
        'MaterialCategory', 'SurfaceCondition', 'SurfaceAssessment',
        'MaterialStandard', 'MaterialInspector', 'assess_surface',
        'validate_against_standard', 'generate_compliance_report'
    ],
    'socrata_toolkit.quality_integration': [
        'QualityIntegration', 'QualityFramework', 'QualityPipeline',
        'create_quality_pipeline', 'run_all_quality_checks'
    ],
    'socrata_toolkit.spatial_database': [
        'SpatialIndex', 'GeometryHandler', 'SpatialQuery',
        'create_spatial_index', 'query_geographic_area'
    ],
    'socrata_toolkit.observability_integration': [
        'ObservabilityManager', 'ObservabilityFramework', 'MetricsPipeline',
        'setup_observability', 'record_operation_metrics'
    ],
    'socrata_toolkit.microsoft_graph': [
        'GraphClient', 'GraphAPIClient', 'M365Integration',
        'initialize_graph_api', 'sync_with_graph'
    ],
    'socrata_toolkit.qgis_compatibility': [
        'QGISProject', 'LayerConverter', 'QGISExporter',
        'validate_qgis_compatibility', 'convert_all_layers'
    ]
}
