...
def cleanup_file(file_path: Path):
    ...
    doubles = [
        "quality", "observability", "lineage", "entity", "material", "spatial", 
        "cdc", "dataverse", "llm", "nlp", "qgis", "quantum", "reports", "geo", 
        "engineering", "core", "alerts", "analysis", "governance", "integrations", 
        "tools", "viz", "pipeline", "discovery", "ops", "standards", "sql"
    ]
