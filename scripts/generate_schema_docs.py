...
Queries Socrata for the definitive schema of all 26 datasets and updates DATASETS.md.
"""
...
def update_datasets_md(registry: Dict[str, Any]):
    ...
    md_header = f"# 🏛️ NYC DOT Socrata Toolkit Dataset Directory\n\n"
    md_header += f"**Last Generated:** {now}\n\n"
    md_header += "This document serves as the definitive technical reference for all 26 datasets integrated into the toolkit.\n\n"
