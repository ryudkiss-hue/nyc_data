  ...
  if (isLoading) {
    return (
      <div style={{ padding: "100px", textAlign: "center", fontFamily: "sans-serif" }}>
        ...
        <h2 style={{ marginTop: "24px", color: "#666" }}>SYNCHRONIZING PHASE C TELEMETRY...</h2>
      </div>
    );
  }
  ...
  return (
    <div style={{ background: "#FFFFFF", color: "#000000", padding: "32px", fontFamily: "sans-serif", minHeight: "100vh" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: "40px", borderBottom: "4px solid #005696", paddingBottom: "20px" }}>
        <div>
          <h1 style={{ margin: 0, fontSize: "32px", fontWeight: 900, textTransform: "uppercase", letterSpacing: "1px" }}>Inventory Segmentation Command Center</h1>
          <p style={{ color: "#666", fontSize: "18px", marginTop: "8px" }}>Phase C: Ramp Type Certainty and Distribution Balance</p>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
          <div style={{ padding: "24px", background: "#E3F2FD", borderLeft: "6px solid #005696", borderRadius: "4px" }}>
            ...
            <p style={{ margin: 0, fontSize: "14px", lineHeight: 1.6 }}>
              Phase C telemetry for <strong>{state.borough}</strong> indicates a high degree of variance in <strong>{kpis[0]?.label}</strong>. 
      ...
      <div style={{ marginTop: "60px", borderTop: "1px solid #EEE", paddingTop: "20px", textAlign: "center" }}>
        <p style={{ fontSize: "12px", color: "#AAA", fontWeight: 600, letterSpacing: "1px" }}>
          NYC DOT SIM DASHBOARD · PHASE C COMMAND CENTER · CONFIDENTIAL
        </p>
      </div>
    </div>
  );
