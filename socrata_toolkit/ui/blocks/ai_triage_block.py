...
class AITriageBlock:
            ...
            with ui.row().classes("w-full gap-4 items-start"):
                ...
                with ui.column().classes("w-3/5 flex-grow"):
                    ...
                    with self.results_container:
                        ui.label("Select a dataset and run triage to view AI classifications.").classes(
    ...
    async def _run_stat_model(self, df, text_col: str):
    ...
    async def _run_local_model(self, df, text_col: str):
    ...
    async def _run_gemini_model(self, df, text_col: str):
    ...
    async def _run_legal_model(self, df, text_col: str):
    ...
    def _render_results_grid(self, result_df, text_col: str) -> None:
