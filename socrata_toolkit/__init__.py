...
_lazy_map: dict[str, str] = {
    ...
    "sunburst_chart": "viz:sunburst_chart",
    "treemap_chart": "viz:treemap_chart",
    "gauge_chart": "viz:gauge_chart",
    "animated_scatter_chart": "viz:animated_scatter_chart",
    "violin_plot": "viz:violin_plot",
    "quality_radar_chart": "viz:quality_radar_chart",
    "generate_semantic_network_map": "viz:generate_semantic_network_map",
    "hotspot_density_mapbox": "viz:hotspot_density_mapbox",
    "material_breakdown_pie_chart": "viz:material_breakdown_pie_chart",
    "material_borough_subplots": "viz:material_borough_subplots",
    "operations_gantt_chart": "viz:operations_gantt_chart",
    "triage_funnel_chart": "viz:triage_funnel_chart",
    "plot_sidewalk_anatomy": "viz:plot_sidewalk_anatomy",
    "plot_ada_compliance_map": "viz:plot_ada_compliance_map",
