...
try:
    ...
    from socrata_toolkit.schema_registry import SchemaRegistry, SchemaChange
    from socrata_toolkit.lineage_core import DAG, TransformationNode, NodeType
    from socrata_toolkit.material_compliance import ComplianceChecker
except ImportError:
    ...
    def _check_compliance(
        ...
        try:
            if cdc_event.after:
                ...
                violations = self.compliance_checker.validate_design_rules(
                    cdc_event.source_dataset,
                    cdc_event.after
                )
