...
def parse_query(text: str) -> Optional[QueryIntent]:
    """
    ...
    # --- Define Keywords ---
    intents = {'show': 'show', 'map': 'show', 'plot': 'show', 'count': 'count', 'compare': 'compare', 'what is': 'get'}
    targets = {'defect': 'defects', 'inspection': 'inspections', 'cost': 'cost', 'rate': 'rate', 'compliance': 'compliance'}
