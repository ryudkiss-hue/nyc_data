...
from .schema_registry import SchemaRegistry, SchemaValidator, BackwardCompatibilityChecker
from .lineage_core import DAG, TransformationNode, NodeType
from .lineage_query import LineageQuery
from .lineage_visualization import LineageVisualizer
from .lineage_impact import ImpactAnalysis
...
def material_list(ctx, category, json_out):
    ...
    try:
        from socrata_toolkit.material_definitions import MATERIAL_DEFINITIONS, get_material_by_category
        from socrata_toolkit.material_standards import MaterialCategory
...
def material_show(material_id, json_out):
    ...
    try:
        from socrata_toolkit.material_definitions import get_material_by_id
...
def material_ada_rules(material_id):
    ...
    try:
        from socrata_toolkit.material_definitions import get_material_by_id
        from socrata_toolkit.design_rules import get_rules_for_material
...
def compliance_check(material_id, condition, json_out):
    ...
    try:
        from socrata_toolkit.material_definitions import get_material_by_id
        from socrata_toolkit.material_standards import SurfaceCondition, SurfaceAssessment
...
def compliance_ada_violations(severity, json_out):
    ...
    try:
        ...
        from socrata_toolkit.material_standards import ADAFailureSeverity
...
def compliance_report(material, json_out):
    ...
    try:
        from socrata_toolkit.design_rules import get_critical_rules, get_rules_by_severity
        from socrata_toolkit.material_standards import ADAFailureSeverity
...
def observability_status():
    ...
    try:
        from .observability_integration import get_observability_manager
