        ...
        [
                        ...
                        [
                            ...
                            dmc.Stack(
                                [
                                    ...
                                    dmc.Text(
                                        "Analyze the shape of numeric columns (normal, skewed, heavy-tailed, etc.)",
                                        size="sm",
                                        c="dimmed",
                                    ),
                                ],
            ...
            dmc.Group(
                [
                    ...
                    dmc.Text(
                        "Cache TTL: 10 minutes | Latency target: <300ms", size="xs", c="dimmed"
                    ),
                ]
            ),
        ],
        ...
        [
                        ...
                        [
                            ...
                            dmc.Stack(
                                [
                                    ...
                                    dmc.Text(
                                        "Identify outliers and spatial anomalies in the data",
                                        size="sm",
                                        c="dimmed",
                                    ),
                                ],
            ...
            dmc.Group(
                [
                    dmc.Badge("Performance", size="sm", variant="dot"),
                    dmc.Text(
                        "Cache TTL: 5 minutes | Latency target: <400ms", size="xs", c="dimmed"
                    ),
                ]
            ),
        ],
        ...
        [
            ...
            dmc.Group(
                [
                    dmc.Badge("Performance", size="sm", variant="dot"),
                    dmc.Text(
                        "Cache TTL: 15 minutes | Latency target: <500ms | Window: 7-day moving average",
                        size="xs",
                        c="dimmed",
                    ),
                ]
        ...
        [
            ...
            dmc.Group(
                [
                    dmc.Badge("Performance", size="sm", variant="dot"),
                    dmc.Text(
                        "Cache TTL: 10 minutes | Latency target: <300ms | Method: Non-parametric bootstrap",
                        size="xs",
                        c="dimmed",
                    ),
                ]
        ...
        [
                    ...
                    dmc.Group(
                        [
                            ...
                            dmc.Stack(
                                [
                                    dmc.Text(
                                        "Moran's I Spatial Autocorrelation", fw=700, size="lg"
                                    ),
                                    dmc.Text(
                                        "Detect spatial clustering vs. dispersion patterns",
                                        size="sm",
                                        c="dimmed",
                                    ),
                                ],
            ...
            dmc.Group(
                [
                    dmc.Badge("Performance", size="sm", variant="dot"),
                    dmc.Text(
                        "Cache TTL: 10 minutes | Latency target: <200ms | Method: K-nearest neighbors weights",
                        size="xs",
                        c="dimmed",
                    ),
                ]
