    ...
    children=[
        ...
        dcc.Store(
            ...
            data={
                ...
                "metric_type":         "all",
                "datasets":            [
                    "inspection", "violations", "built", "reinspection",
                    "dismissals", "correspondences", "tree_damage", "curb_metal_protruding",
                    "ramp_complaints", "ramp_progress", "complaints_311",
                    "capital_projects_dashboard", "capital_budget", "lot_info",
                ],
                "data_limit":          "none",
            },
            storage_type="memory",
        ),
        dcc.Store(id="store-page-rendered", data=None),
        ...
        dmc.AppShell(
            ...
            children=[
                render_header(),
                render_sidebar(),
                dmc.AppShellMain(id="page-content", children=[layout_dashboard()]),
            ],
