...
class IntegrationExample:
    ...
    def __init__(self):
        ...
        self.results = {"started_at": self.start_time.isoformat(), "steps": []}
    ...
    def verify_schema(self) -> bool:
        ...
        try:
            ...
            self.log(
                "Schema Verification",
                status,
                f"Found {len(tables_found)}/{len(required_tables)} tables",
            )
    ...
    def check_sample_data(self) -> bool:
        ...
        try:
            ...
            message = (
                f"Inspections: {insp_count}, Complaints: {compl_count}, Contractors: {contr_count}"
            )
    ...
    def query_sample_data(self) -> bool:
        ...
        try:
            ...
            headers = {"Authorization": f"Bearer {API_KEY}"}
            response = requests.get(
                f"{API_BASE_URL}/api/v1/sidewalk_inspections?limit=5", headers=headers, timeout=10
            )
    ...
    def run_all_checks(self) -> bool:
        ...
        self.results["summary"] = {"passed": passed, "total": total, "success": passed == total}
