...
## From Fragmented to Unified — How EXPANDED_KPI_CHART_REGISTRY.md Supersedes Prior Docs

**Effective Date:** 2026-06-17  
**Action:** All team members must reference EXPANDED_KPI_CHART_REGISTRY.md going forward  
...
### 1. docs/KPI_METRICS_REFERENCE.md
**What it said:** 60+ statistical metrics (mean, median, std dev, quantiles, outliers, etc.)

**How it's superseded:**
- Registry Chapter 3 includes all KPI definitions with data requirements
...
**Migration steps:**
- ✅ If you need a metric formula: Registry Ch. 3 has all 51 KPI calculations
- ✅ If you need a metric visualization: Registry Ch. 4 has the chart for that metric
- 🚫 Do NOT consult KPI_METRICS_REFERENCE.md for new implementations

---

### 2. docs/PHASE1_KPI_MAPPINGS.md
**What it said:** 21 datasets, 51 KPI definitions, targets, SLA thresholds, data stories

**How it's superseded:**
- Registry Chapter 3 includes COMPLETE KPI-to-Chart mapping for all 51 KPIs
- Each row shows: KPI ID | Name | Primary Chart | Alternatives | Data Shape | Configs
- Everything from PHASE1_KPI_MAPPINGS is rolled into the matrix

**Migration steps:**
- ✅ If you need KPI definition: Registry Ch. 3, find your KPI ID (PRM-001, etc.)
...
- 🚫 Do NOT reference PHASE1_KPI_MAPPINGS.md; use Registry instead

**Mapping Comparison:**

| Old Document (PHASE1_KPI_MAPPINGS.md) | New (EXPANDED_KPI_CHART_REGISTRY.md) |
|---------------------------------------|---------------------------------------|
...
### 3. UNIFIED_KPI_REGISTRY_MASTER_PLAN.md
...
- All 51 KPI configs ready → no more "to-be-determined"
...
- ✅ For team assignments: Each subagent gets one KPI group (e.g., 10 KPIs) from Ch. 3
- ✅ For success criteria: See Ch. 8 performance targets (ready to test)
- 🚫 Do NOT consult UNIFIED_KPI_REGISTRY_MASTER_PLAN.md; use Registry + this index

---

### 4. app/components/kpi_cards.py
**What it said:** Python component code for KPI cards (partial, incomplete)

**How it's superseded:**
- Appendix B has COMPLETE KPICard class with full docstrings
...
**Migration steps:**
- ✅ If updating KPI card component: Use Appendix B template, not kpi_cards.py
...
- 🚫 Do NOT modify kpi_cards.py directly; reference Registry templates first

---

### 5. app/visualization_engine/kpi_cards.py
...
#### KPI_METRICS_REFERENCE.md → Registry Chapters 3-4

| Old Section | New Location | Details |
|-------------|-------------|---------|
| Central Tendency (mean, median, mode) | Ch. 3: KPI definitions | All KPIs include statistical basis |
...
#### PHASE1_KPI_MAPPINGS.md → Registry Chapter 3

| Old Section | New Location | Example Mapping |
|-------------|-------------|-----------------|
| 1. Permit Variants (13 KPIs) | Ch. 3: 13 KPI rows | PRM-001 to CLS-004 |
| 2. Pedestrian Infrastructure (14 KPIs) | Ch. 3: 14 KPI rows | PED-001 to ADA-003 |
| 3. Street Safety (12 KPIs) | Ch. 3: 12 KPI rows | PARK-001 to VZ-002 |
| 4. Budget & Vendor (7 KPIs) | Ch. 3: 7 KPI rows | CAP-001 to COORD-002 |
| 5. Reference & Compliance (5 KPIs) | Ch. 3: 5 KPI rows | GEO-001 to CMP-003 |
| **Total** | **Ch. 3 Matrix: 51 rows** | All KPIs with primary + alt charts |

#### kpi_cards.py (Code) → Registry Appendix B

| Old Code | New Location | Example |
|----------|-------------|---------|
| KPICard class definition | Appendix B: KPICard class | Full implementation with docstrings |
...
| Callback for drill-down | Appendix B: Drill-down callback | drill_down_on_kpi_click() |
| CSS styling | Ch. 5: Mantine CSS | .kpi-card, .kpi-status-*, breakpoints |
...
### Q1: "I was using KPI_METRICS_REFERENCE.md to understand metrics. Where do I go now?"
**A:** Registry Chapter 3 lists all 51 KPIs with their calculation basis. For any KPI:
1. Find your KPI ID in Ch. 3 matrix
...
### Q2: "I'm implementing a new chart. Should I follow kpi_cards.py or the Registry?"
**A:** Always follow the Registry. kpi_cards.py is legacy code. Here's why:
- Registry Ch. 4 has ALL chart type templates (bar, gauge, heatmap, etc.)
- Appendix B has production-ready component code
- kpi_cards.py only covers gauges, incomplete

### Q3: "My manager asked about KPI definitions. Which document should I share?"
**A:** Share Registry Chapter 3 (KPI-to-Chart Mapping Matrix). It's complete, organized by category, and shows chart recommendations. PHASE1_KPI_MAPPINGS.md is outdated.
...
### Q5: "The old plan said 51 KPIs would take 10 weeks. Can we go faster?"
**A:** Yes. Registry is production-ready. Timeline with Registry:
- **Week 1-2:** Implement 11 chart templates from Ch. 4 (parallel)
- **Week 3-4:** Build KPI cards using Appendix B (10 KPIs per dev)
...
### If You Were Using KPI_METRICS_REFERENCE.md:
- [ ] Switch to Registry Chapter 3 for KPI definitions
...
### If You Were Using PHASE1_KPI_MAPPINGS.md:
- [ ] Switch to Registry Chapter 3 (KPI-to-Chart Matrix)
- [ ] Update any Jira epics referencing old doc
- [ ] Note: Registry goes beyond mappings → includes full configs
- [ ] Archive old doc

### If You Were Editing app/components/kpi_cards.py:
...
### If You Were Following UNIFIED_KPI_REGISTRY_MASTER_PLAN.md:
...
- 51 KPIs across 5 categories (Permits, Infrastructure, Safety, Budget, Compliance)
- Definitions with target SLA thresholds
- Data stories for each KPI
- 21 datasets mapped to 51 KPIs
...
**kpi_cards.py:**
- Python class for KPI card components
...
**visualization_engine/kpi_cards.py:**
- Visualization patterns for KPI rendering
...
✅ **DO** reference `EXPANDED_KPI_CHART_REGISTRY.md` for all visualization work  
✅ **DO** use Registry Chapter 3 for KPI definitions  
...
OLD                                 NEW
──────────────────────────────────────────────────────────────
KPI_METRICS_REFERENCE.md       →    Registry Ch. 3-4 (KPI defs + charts)
PHASE1_KPI_MAPPINGS.md         →    Registry Ch. 3 (KPI-to-chart matrix)
UNIFIED_KPI_REGISTRY_*_PLAN    →    Registry Ch. 1-9 (complete spec)
kpi_cards.py                   →    Registry Appendix B (KPICard class)
visualization_engine/          →    Registry Ch. 4-7 (all patterns)

docs/KPI_*.md                  →    ARCHIVE (keep for audit)
app/visualization_engine/      →    REFERENCE ONLY (legacy code)
UNIFIED_KPI_REGISTRY_*_PLAN    →    ARCHIVE (keep for timeline history)
```
...
If you have in-progress work on visualization or KPI components:
...
git checkout main
git pull
git checkout -b feature/kpi-cards-refactor
...
git add .
git commit -m "Refactor KPI cards to use EXPANDED_KPI_CHART_REGISTRY templates"
git push -u origin feature/kpi-cards-refactor
```
...
**Q: My code uses patterns from kpi_cards.py. Do I need to refactor?**
