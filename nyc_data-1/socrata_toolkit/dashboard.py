...
def _page_dashboard(st) -> None:
    ...
    if "borough" in df.columns:
        ...
        from .borough_analysis import borough_comparison_table
...
def _page_task_board(st) -> None:
    ...
    from .task_board import TaskBoard, Task, STATUS_LABELS, PRIORITY_COLORS, CATEGORY_COLORS
...
def _page_construction(st) -> None:
    ...
    from .construction_list import prioritize_construction_list, classify_scope, flag_ada_locations, summarize_construction_list, export_construction_list
...
def _page_contracts(st) -> None:
    ...
    from .contract_analytics import analyze_contract_progress, budget_analysis, productivity_metrics
