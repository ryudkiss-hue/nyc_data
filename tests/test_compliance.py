...
from socrata_toolkit.compliance import check_dcwp_license, check_parks_permit, validate_contractor_for_list
...
def test_validate_contractor_for_list(monkeypatch):
    ...
    monkeypatch.setattr("socrata_toolkit.compliance.requests.get", fake_get)
