...
def sample_dataframe():
    ...
    return pd.DataFrame({
        ...
        "location_address": ["123 Main St", "456 Broadway", "789 5th Ave", "321 Park Ave", "654 Madison Ave"],
...
def invalid_dataframe():
    ...
    return pd.DataFrame({
        ...
        "location_address": ["123 Main St", "456 Broadway", None, "321 Park Ave", "654 Madison Ave"],
