import pandas as pd
import pytest
from app.analytics import _estimate_cardinality, _compute_duplicate_pct
...
def test_duckdb_fallback_on_error(mocker):
    ...
    mocker.patch("socrata_toolkit.core.duckdb_store.DuckDBManager", side_effect=Exception("DB Locked"))
